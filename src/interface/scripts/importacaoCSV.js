...
function importaDados(callback){
  ...
  for(var i=0;i<dados.length;i++){
    ...
    try{
      console.log("PASSO "+i+":\n\n"); 
      if(import_cont===0){
      	importar("pessoa",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===1){
      	importar("servidor",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===2){
      	importar("tecnico_adm",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===3){
      	importar("docente",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===4){
      	importar("docente_tecnico",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===5){
      	importar("instituicao",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===6){
      	importar("curso",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===7){
      	importar("instrutor_pessoa",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===8){
      	importar("instrutor",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===9){
      	importar("capacitacao",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===10){
      	importar("pessoa_curso",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===11){
      	importar("entrevista",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===12){
      	importar("opniao",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===13){
      	importar("atividade",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===14){
      	importar("pessoa_atividade",dados,i,con);
      	import_cont+=1;
      }
      if(import_cont===15){
      	importar("indicacao",dados,i,con);
      	import_cont=0;
      }
...
function importar(tabela,dados,i,con){
  var crypto=require("crypto");
  var valores=[];
  switch(tabela){
      case "pessoa":
      ...
      case "curso":
            ...
            var v1 = gravaCurso(dados[i].b5,14,dados[i].b5a,dados[i].b5b);
            var v2 = gravaCurso(dados[i].b10,14,dados[i].b10a,dados[i].b10b);
            var v3 = gravaCurso(dados[i].b10a1,14,dados[i].b10b2,dados[i].b10b3);
            //V4, V5 = ESPECIALIZAÇÃO (CÓDIGO 15)
            var v4 = gravaCurso(dados[i].b15,15,dados[i].b15a,dados[i].b15b);
            var v5 = gravaCurso(dados[i].b20,15,dados[i].b20a,dados[i].b20b);
            //V6,V7 = MESTRADO (CÓDIGO 16)
            var v6 = gravaCurso(dados[i].b25,16,dados[i].b25a,dados[i].b25b);
            var v7 = gravaCurso(dados[i].b30,16,dados[i].b30a,dados[i].b30b);
            //V8 = DOUTORADO (CÓDIGO 17)
            var v8 = gravaCurso(dados[i].b35,17,dados[i].b35a,dados[i].b35b);
            //V9 = POS-DOUTORADO (CÓDIGO 18)
            var v9 = gravaCurso(dados[i].b40,18,dados[i].b40a,dados[i].b40b);

            //CAPACITAÇÃO:
            var c1 = gravaCurso(dados[i].c1,19,dados[i].c1a,null);
            var c7 = gravaCurso(dados[i].c7,19,dados[i].c7a,null);            
            var c13 = gravaCurso(dados[i].c13,19,dados[i].c13a,null);
            var c19 = gravaCurso(dados[i].c19,19,dados[i].c19a,null);
            var c25 = gravaCurso(dados[i].c25,19,dados[i].c19a,null);
            var c31 = gravaCurso(dados[i].c31,19,dados[i].c31a,null);
            var c37 = gravaCurso(dados[i].c37,19,dados[i].c37a,null);
            var c43 = gravaCurso(dados[i].c43,19,dados[i].c43a,null);
            var c49 = gravaCurso(dados[i].c49,19,dados[i].c49a,null);
            var c55 = gravaCurso(dados[i].c55,19,dados[i].c55a,null);
            var c61 = gravaCurso(dados[i].c61,19,dados[i].c61a,null);
            var c67 = gravaCurso(dados[i].c67,19,dados[i].c67a,null);
            var c73 = gravaCurso(dados[i].c73,19,dados[i].c73a,null);
            var c79 = gravaCurso(dados[i].c79,19,dados[i].c79a,null);
            var c85 = gravaCurso(dados[i].c85,19,dados[i].c85a,null);
            var c91 = gravaCurso(dados[i].c91,19,dados[i].c91a,null);
            var c97 = gravaCurso(dados[i].c97,19,dados[i].c97a,null);
            var c103 = gravaCurso(dados[i].c103,19,dados[i].c103a,null);
            var c109 = gravaCurso(dados[i].c109,19,dados[i].c109a,null);
            var c125 = gravaCurso(dados[i].c125,19,dados[i].c125a,null);
            
            var l3 = gravaCurso(dados[i].l4,19,null,null);
            var l7 = gravaCurso(dados[i].l8,19,null,null);
            var l11 = gravaCurso(dados[i].l12,19,null,null);

            //GRAVANDO CURSO MÉDIO, TEM QUE CHECAR SE É NORMAL OU PROFISSIONALIZANTE
            var m2;
            if(dados[i].m1===2){
              var m2 = gravaCurso(dados[i].m2,10,null,null);  
            }
            else if(dados[i].m1 ===1){
              var m2 = gravaCurso(dados[i].m2,21,null,null);
            }
            var m7 = gravaCurso(dados[i].m7,20,null,null);
            var m12 = gravaCurso(dados[i].m12,20,null,null);
            var m17 = gravaCurso(dados[i].m17,20,null,null);
      ...
      case "capacitacao":
            ...
            break;
      case "entrevista":
            var valores = [[dados[i].n1,null,pessoaid,dados[i].n5a,null,null,null,null,null,null,dados[i].p1,dados[i].p2,dados[i].n5,dados[i].n6,dados[i].o1,dados[i].p3,dados[i].p4,dados[i].p5,dados[i].p6]];
            break;
      case "opniao":
...
function gravaCurso(nome_curso,tipo,area_temat,area_conh){
  if(nome_curso === 88 || nome_curso === "NA" || nome_curso === "NS" || nome_curso === ""||nome_curso==="NULL"||nome_curso==="null")
    return;
  var conteudo = nome_curso+tipo;
